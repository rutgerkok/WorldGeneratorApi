...
public interface Version {
    ...
    /**
     * Checks if this API is compatible with the expected version number. If
     * your plugin expected version 1.3, and we're on 1.5, then it is likely
     * compatible. However, if your plugin expects version 2.0 and we're on 1.4,
     ...
     * @return True if this version is likely compatible with the provided
     *         version.
     */
