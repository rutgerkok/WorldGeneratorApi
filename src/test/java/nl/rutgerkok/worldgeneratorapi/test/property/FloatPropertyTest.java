...
public class FloatPropertyTest {
    ...
    public void biomeDefault() {
        ...
        assertEquals(0, property.get(world, Biome.COLD_BEACH));
    ...
    public void biomeDefaultOverridesWorldDefault() {
        ...
        property.setBiomeDefault(Biome.COLD_BEACH, 6);
        assertEquals(6, property.get(world, Biome.COLD_BEACH));

        property.setWorldDefault(world, 7);
        assertEquals(6, property.get(world, Biome.COLD_BEACH)); // Value must not have been changed
    }
    ...
    public void biomeInWorldDefault() {
        ...
        property.setBiomeDefault(Biome.COLD_BEACH, 3);
        property.setBiomeInWorldDefault(world, Biome.COLD_BEACH, 6);
        assertEquals(6, property.get(world, Biome.COLD_BEACH));
        assertEquals(3, property.get(otherWorld, Biome.COLD_BEACH));
    }
    ...
    public void biomeInWorldDefaultOverridesWorldDefault() {
        ...
        assertEquals(2, property.get(world, Biome.BEACHES));
        assertEquals(6, property.get(world, Biome.COLD_BEACH));
    ...
    public void defaultValueCanBeChanged() {
        ...
        assertEquals(3, property.get(world, Biome.COLD_BEACH));
    }
    ...
    public void worldDefault() {
        ...
        assertEquals(5, property.get(world, Biome.COLD_BEACH));
    }
}
